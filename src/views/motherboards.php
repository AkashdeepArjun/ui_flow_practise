<?php
$js=BASE_URL.'/assets/js/stock_motherboards.js';
...
<html lang="en">
    ...
    <body>
<script type="text/javascript" src="<?=BASE_URL?>assets/js/stock_motherboards.js?v=<?=$js_ver?>">
            
        </script>

        <h1>Motherboards List will show up here</h1>
